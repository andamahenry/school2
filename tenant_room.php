...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<nav>
				<head>
				<center><h4><strong>View Student according to their respective Class</strong></h4></center>
					   <div class="col-sm-12">
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
									...
									<?php
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to View." href="view_tenant.php<?php echo '?id='.$row['room_name'];?>">View Student</a></center></td>
											</center>
