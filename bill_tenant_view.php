...
<head>
  ...
  <body>
	...
	?>
				<center><h2>Tenant From&nbsp;<?php echo $room_name; ?><h2></center>
				<div id="block_bg" class="block">	
                            <div class="navbar navbar-inner block-header">
                            <div class="block-content collapse in">
                                <div class="span12">
								<td><a button class="btn btn-primary" title="Click here to View." href="bill_tenant.php">Back</a></td>
								<!-----------------------form --------------------->
								<form method="post">
						...
						?>
						<tr class="edit_tr">
						<td><center><h5><?php echo $row['fname']; ?></h5></center></td>
						<td><center><h5><?php echo $row['mname']; ?></h5></center></td>
						<td><center><h5><?php echo $row['lname'] ?></h5></center></td>
						<td><center><a button class="btn btn-success" title="Click here to View." href="bill.php<?php echo '?id='.$row['tenant_id'];?>">Generate Bill</a></center></td>
						</tr><?php }?>
						</tbody>
						</table>
						</form>
