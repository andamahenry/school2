		...
		<table border=1 class="marksheet_table" width='100%'>
			...
			<?php
				...
				$query2=mysql_query("SELECT sno,fname,lname FROM students WHERE room_name='$class' AND active='yes' 
									ORDER BY fname ASC LIMIT 4	",$con) or die('Kano: '.mysql_error());
				...
				?>
					<tr>
						<td rowspan='3'><center><?php echo $std_no;?></center></td><td rowspan='3'><?php echo $std_name;?></td>
						...
						<!-- For Each Subject In Row-->
						<?php
						if(COUNT($std_principle_subjects) >= 3){//For three or more principle subjects
							$subject1 = $std_principle_subjects[0];
							$subject2 = $std_principle_subjects[1];
						...
						<?php	
						for($j=0;$j < 3;++$j){//A test script that prints student marks and details on the screen
						...
						<?php
							foreach($principle_subjects[$subject1] as $paper => $mark){//Extract paper number e.g, I, II
						?>
								<td><center><?php echo strtoupper($paper);?></center></td>
						<?php
							}
							//print COUNT($principle_subjects[$subject1]);
							if(COUNT($principle_subjects[$subject1])==2){//Add two cells if there are only two subject papers 
								echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}elseif(COUNT($principle_subjects[$subject1])==3){//Add one cell if there are only two subject papers 
								echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}						
						...
						<?php
							foreach($principle_subjects[$subject2] as $paper => $mark){//Extract paper number e.g, I, II
						?>
								<td><center><?php echo strtoupper($paper);?></center></td>
						<?php
							}
							//print COUNT($principle_subjects[$subject1]);
							if(COUNT($principle_subjects[$subject2])==2){//Add two cells if there are only two subject papers 
								echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}elseif(COUNT($principle_subjects[$subject2])==3){//Add one cell if there are only two subject papers 
								echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}						
						?>
						...
						<?php
							foreach($principle_subjects[$subject3] as $paper => $mark){//Extract paper number e.g, I, II
						?>
								<td><center><?php echo strtoupper($paper);?></center></td>
						<?php
							}
							//print COUNT($principle_subjects[$subject1]);
							if(COUNT($principle_subjects[$subject3])==2){//Add two cells if there are only two subject papers 
								echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}elseif(COUNT($principle_subjects[$subject3])==3){//Add one cell if there are only two subject papers 
								echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}						
						?>
					...
					<tr>
						...
						<?php
							foreach($principle_subjects[$subject1] as $paper => $mark){
								//print $paper.'*******'.$mark.'<br>';
						?>
						
								<td><center><?php echo strtoupper($mark);?></center></td>
