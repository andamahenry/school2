							...
							<!--------------------form------------------->
								<form method="post">
                                    <tbody>
									  ...
									  <input type="text" class="form-control" id="room_name" name="room_name" value="Name" required>
									  </div>
...
mysql_query("insert into room (room_name,rental) values('$room_name','$rental')")or die(mysql_error());
