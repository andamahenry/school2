...
if (isset($_POST['register'])){
	...
	for($counter=0;$counter < COUNT($id);++$counter){
		mysql_query("UPDATE ncdc_olevel SET applicable='yes' WHERE id='$id[$counter]'",$con);//or die(mysql_error();
	}		
}
if(isset($_GET['id'])){
	$id = $_GET['id'];
	mysql_query("UPDATE ncdc_olevel SET applicable='no' WHERE id='$id'",$con);
}
?>
    ...
    <form role="form" method="post" name='form1'  action="">
		...
		<div class="row">
			<div class="col-xs-8">
				...
				<?php
				$query = mysql_query("SELECT id,subject FROM ncdc_olevel ORDER BY type ASC,subject ASC",$con);
        ...
        <hr>	   
            ...
            <div class="box-header">
              <h3 class="box-title"><center>List Of Subjects Offered At School.</center></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover" width = "50%">
				...
				<tbody>
					<?php 
					$no = 1;
					$query=(mysql_query("SELECT * FROM ncdc_olevel WHERE applicable='yes' ORDER BY type ASC,subject ASC ",$con))or die(mysql_error());
...
function deleteSubject(id){
	window.location.assign("./subject_add_o.php?id="+id);
}
</script>
