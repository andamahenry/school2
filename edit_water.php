...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/calculator.png">
    ...
    <title>Edit Admission Fee</title>
...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">&nbsp;Edit Admission Fee For Student :  <?php echo"".$rec['fname']."&nbsp;".$rec['lname'].""?></div>
                        ...
                        <div class="panel-body">
							...
							<!--------------------form------------------->
							  ...
							  <?php 
									...
									value='".$water."' class='form-control input-md'>";
							  ?>
							<br>
						        <button name="update" class="btn btn-success">Update</button>
						        <a button name="cancel" class="btn btn-primary" href="water.php">Cancel</a></button>
						    </div>
						...
						if (($_POST['water'] == ''))
						{
							...
							$w = addslashes("$_POST[water]");
							{
							}
							//dri nah mah edit xng data
							mysql_query("UPDATE tenant SET water ='$w' where tenant_id='$id'")or die(mysql_error()); 
					}?>
							<script>
