    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<?php
				...
				?>
				<center><h4><strong><?php echo $ourname; ?>,&nbsp;Teacher Form</strong><h4></center>
				<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
					   ...
					   <!-- Modal -->
						...
						if(isset($_POST['delete'])){
							...
							for($i=0; $i < $N; $i++)
							{
								$result = mysql_query("DELETE FROM teachers WHERE id='$id[$i]'");
								//print $id[$i];
							}
						}
						?>
						...
						<div class = "form-group">
							...
							<input type = "text" id = "search_input" class="form-control" width="20%" placeholder = "Type First Name to filter" onkeyup = "searchFunction()"></input>
                        </div>
                    ...
                    <div class="span12">
						...
						<?php 
						//$class=$_GET['id'];
						$query=mysql_query("SELECT * FROM teachers ORDER BY name ASC")or die('Hooo Kakano: '.mysql_error());
						...
						<td class="col-md-1">
						<center><a href="teacher_edit.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
						</center>
						</td>			
						</tr>
						<?php } ?>
					...
					<p><i style="color:red; background-color:yellow"><h4>Note: Please check the checkbox if you want to delete a Teacher!!!</h4></i></p>
                    </div>
					</div>
				</div>
			</div>
