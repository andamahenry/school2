        ...
        <div class="box-body">
         <!-- general form elements -->
          <div class="box box-primary">
           <div class="box-header with-border">
              <h3 class="box-title"><center>All Fields are required.</center></h3><hr>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
           <form role="form" method="post" name='form1'  action="grading.php" >
               <div class="container">
			  </br>
			  <div class="row">
           <div class="col-xs-5">
         ...
         <hr>
			...
			<?php
				...
				if(mysql_num_rows(mysql_query("SELECT * FROM grading WHERE grade='$grade' AND points='$points'",$con))){
				//CHECKS WHETHER THE ENTRY IS NOT ALREADY IN SYSTEM
				}else
					{
					mysql_query("insert into grading (grade,points,max,fro,comment) values('$grade','$points','$max','$from','$comment')",$con)or die(mysql_error());
					}
				}
			?>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
					...
					<tbody>
						...
						$query=mysql_query("SELECT *  FROM `grading` ORDER BY points DESC",$con)or die(mysql_error());
						...
						<td><a href="grading_edit.php?id=<?php echo $id; ?>"><input type='submit' class="btn btn-success addmore" value='Edit'>	</a></td>
						<td><a href="grading_delete.php?id=<?php echo $row['id']; ?>"><input type='submit' onClick="return confirm('Are you sure you want to Delete?');" class="btn btn-danger delete" value='Delete'>	</a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
