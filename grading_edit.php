...
if(isset($_GET['id'])){
	...
	if(isset($_POST['register']))
	{
		...
		$sql = ("UPDATE grading SET fro='$gfrom', max='$gto', grade='$grade', points='$points', comment='$comment' WHERE id='$id'");//,$con);
...
<?php
	...
	$id=$_GET['id'];
	$result = mysql_query("SELECT * FROM grading WHERE id= '$id'",$con);
