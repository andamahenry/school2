...
<div id="page-wrapper">
			...
			<br>
				...
				<head>
					   ...
					   <?php	
	                   $count_client=mysql_query("select * from room ORDER BY room_name ASC");
					   ...
					   <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						if(isset($_POST['delete'])){
							...
							for($i=0; $i < $N; $i++)
							{
								$result = mysql_query("DELETE FROM room where room_id='$id[$i]'");
							}
						...
						?>
							<center><h4><strong>View Class</strong></h4></center>
					   <div class="col-sm-12">
								...
								<!-----------------------form --------------------->
									...
									&nbsp;&nbsp;<button type='button' class="btn btn-danger" data-toggle='modal' data-target='#myModal'><i class="glyphicon glyphicon-trash"></i></button>
										...
										<thead>
										  <tr>
												<th></th>
												<th>Class</th><div class="muted pull-right">&nbsp;Class Available</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
										...
										<tbody>
											<?php
													$user_query = mysql_query("select * from room ORDER BY room_name ASC")or die(mysql_error());
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to edit this room." href="edit_room.php<?php echo '?id='.$row['room_id'];?>">Edit Class</a></center></td>
											</center>
