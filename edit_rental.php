...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">&nbsp;Edit Fees</div>
                        ...
                        <div class="panel-body">
							...
							<!--------------------form------------------->
							  ...
							  <?php 
									...
									echo "<input id='rental' name='rental' type='text' onChange='updatesum()' 
									value='".$rental."' class='form-control input-md'>";
							  ?>
							<br>
						        <button name="update" class="btn btn-success">Update</button>
						        <a button name="cancel" class="btn btn-primary" href="rental.php">Cancel</a></button>
						    </div>
						...
						if (($_POST['rental'] == ''))
						{
							...
							$r = addslashes("$_POST[rental]");
							{
							}
							//dri nah mah edit xng data
							mysql_query("UPDATE room SET rental ='$r' where room_id='$id'")or die(mysql_error()); 
					}?>
							<script>
