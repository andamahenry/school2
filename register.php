...
if (isset($_POST['register'])){
	...
	if(!isset($errMSG)){
		if(mysql_num_rows(mysql_query("SELECT sno,fname FROM students WHERE sno='$stdno' AND fname='$fname'"))){
			$errMSG="The Student ".$fname." is already in Database...";
		}else{	
			if(mysql_num_rows(mysql_query("SELECT sno FROM students WHERE sno='$stdno'"))){
			$errMSG="The Student Number ".$stdno." is already in Database...";
			}else{
				$query = mysql_query("insert into students (tenant_id,room_name,stream,sno,fname,lname,nname,gender,age,photo,bdate,
				address,contact,account,date_registered,active) values('','$room_name','$stream','$stdno','$fname','$lname','$nname','$gender',
				'$age','$newImagefile','$bdate','$address','$contact','$account','$date_registered','yes')") or die(mysql_error());

				if($query){				
					$successMSG = "New Student Admitted Succesfully ...";
...
<head>
  ...
  <body>
    ...
    <div id="wrapper">
		...
		<div class="row">
		<div class = "col-md-2">
			<img src="#" class="" name="studentphoto" id="blah" width = "250" height = "250"/>
		</div>
		...
		<div class="col-md-10">
			...
			<div>
				<div class="form-group">
					...
					<div class="col-md-3"><input type="text" class="form-control" name="stream" id="stream" placeholder="Type Stream"/></div>
				</div>
				<div>
					<div class="form-group">
					...
					<div class="col-md-3"><input type="text" class="form-control" name="student_number" id="stdno" placeholder="student number" readonly></input></div>	
					</div>
				<script> 
				...
				<div class="col-md-3"><input type="text" class="form-control" name="account_number" id="accno" placeholder="Fees Payment A/C number" /></div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
						...
						<div class="col-md-3">
						<input type="date" name="bdate" id = "bdate" title="click to choose a date" class="form-control input-md" placeholder="1995-1-31" required/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="file" name="imagephoto" id = "photo" class="form-control input-md" placeholder="Image" onchange="readURL(this);" required/>
					</div>
