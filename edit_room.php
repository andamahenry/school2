 ...
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<!--------------------form------------------->
							  ...
							  <?php 
									...
									echo "<input id='room_name' name='room_name' type='text' onChange='updatesum()' 
									value='".$room_name."' class='form-control input-md'>";
							  ?>
							<br>
						        <button name="update" class="btn btn-success">Update</button>
						        <a button name="cancel" class="btn btn-primary" href="view_room.php">Cancel</a></button>
						    </div>
						...
						if (($_POST['room_name'] == ''))
						{
							...
							mysql_query("UPDATE room SET room_name ='$r' where room_id='$id' AND room.room_id='$id'")or die(mysql_error()); 
					}?>
							<script>
