...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<nav>
				<head>
				<center><h4><strong>Monthly Fees</strong><h4></center>
					   <div class="col-sm-12">
								...
								<!-----------------------form --------------------->
									...
									<thead>
										  ...
										  <th></th>
												...
												<th><center><strong>Fees Amount</strong></center></th>
												<th></th>
										   </tr>
										</thead>
										<tbody>
									...
									?>
										...
										<td width="100"><input type='text' readonly class="form-control input-md" value="<?php echo $row['rental']; ?>"></td>
										<td class="col-md-1">
										<center><a button class="btn btn-success" title="Click here to View." href="edit_rental.php<?php echo '?id='.$row['room_id'];?>">Edit Fees</a></center></td>
										</center>
