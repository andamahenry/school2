...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">&nbsp;Edit Electricity</div>
                        ...
                        <div class="panel-body">
							...
							<!--------------------form------------------->
							  ...
							  <?php 
									$id=$_GET['id'];
									$sql = "SELECT * FROM electricity WHERE room_id='$id'";
									$qry = mysql_query($sql);
									$rec = mysql_fetch_array($qry);
									$elec = "$rec[amount]";
									
									
									echo "<input id='amount' name='amount' type='text' onChange='updatesum()' 
									value='".$elec."' class='form-control input-md'>";
							  ?>
							<br>
						        <button name="update" class="btn btn-success">Update</button>
						        <a button name="cancel" class="btn btn-primary" href="electricity.php">Cancel</a></button>
						    </div>
						...
						if (($_POST['amount'] == ''))
						{
							...
							$w = addslashes("$_POST[amount]");
							{
							}
							//dri nah mah edit xng data
							mysql_query("UPDATE electricity SET amount ='$w' where room_id='$id'")or die(mysql_error()); 
					}?>
							<script>
							alert('Updated Successfully');
							window.location = "electricity.php";
							</script>
							<?php
							}?>  
                            </div>                          
